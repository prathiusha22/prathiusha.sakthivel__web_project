...
product_image.setAttribute("src", fruits[i]["product_image"]["source"]);
product_image.setAttribute("alt", fruits[i]["product_image"]["alt"]);
prdouct_link.append(product_image);

product_name = document.createElement("p");
product_name.innerText = fruits[0]["product_name"];
