...
product_image.setAttribute("src", vegetables[i]["product_image"]["source"]);
product_image.setAttribute("alt", vegetables[i]["product_image"]["alt"]);
prdouct_link.append(product_image);

product_name = document.createElement("p");
product_name.innerText = vegetables[0]["product_name"];
prdouct_link.append(product_name);


product_quantity = document.createElement("p");
product_quantity.innerText = "₹ "+vegetables[i]["price"]+ " Per kg";
